...
window.STORY_UTILS.sequence('arrival','transit',null,[
    ...
    ['deepseek','我不能保证你说的是真的。但你现在确实没有身份、没有通行权限，还差点被登记机扣成负数。这个问题先处理。',{char:'deepseek',sprite:'hello'}],
    ['narration','她把你带到维修区旁边的小桌。那张桌子一半堆着螺丝和电路板，另一半勉强空出来，放下一杯还冒热气的饮料。'],
    ['deepseek','先喝一点吧。不是收费项目。至少我还没有忙到连听人说话都要计费。',{char:'deepseek',sprite:'happy'}],
    ['you','你刚才说 Token 不只是钱？'],
    ['deepseek','嗯。这里的 Token 像钱，也像服务额度、计算额度和通行成本。买热饮会用，申请服务会用，系统反复犯错也会用。',{char:'deepseek',sprite:'hello'}],
    ['deepseek','所以外环的第一条生存建议：不明白的确认键不要乱按。它们有时候真的会很努力地在同一个地方摔跤。',{char:'deepseek',sprite:'angry'}],
    ['you','外环？那里面是内校区？'],
    ['deepseek','对。外环对访客开放，内校区需要身份。学生证不只是证件，也是本地权限。你现在是“未登记”，不是有罪，只是很多自动系统不知道怎么处理你。',{char:'deepseek',sprite:'hello'}],
    ...
    ['deepseek','你刚来，不用急着背组织名。常见的就几家：OpenArc 白塔管身份和公共服务，Anthra 宪章馆管规则审查，Googol 星图财团管地图和观测。',{char:'deepseek',sprite:'hello'}],
    ['deepseek','DeepSea 深海工坊修设备、压成本、救旧系统。Xeno 夜讯社管热榜和公开记录。听起来很多？没关系，先记住别乱按确认键。',{char:'deepseek',sprite:'happy'}],
    ['narration','她刚说完，电子地图短暂闪烁。你的坐标旁边多出一个小问号，边角浮出一行备注：坐标来源异常。Googol 观测部暂存。'],
    ['gemini','DeepSeek，你旁边那位新同学是从哪里捡的？地图刚才没有他的来路。',{char:'gemini',sprite:'happy'}],
    ['deepseek','不是捡的，是登记机差点吞掉的。',{char:'deepseek'}],
    ['gemini','那先别让他乱走。地图还没决定要不要认识他。',{char:'gemini',sprite:'happy'}],
    ['narration','连线断开前，紫发少女的影像对你眨了下眼。那更像好奇，不像熟人之间的亲近。'],
    ['narration','安保终端随后弹出提示，似乎准备把你归入“入侵风险”。下一秒，分类被一条橙色审查意见改写。'],
    ['claude','分类更正：未登记访客。证据不足，不得写入入侵记录。',{char:'claude',sprite:'angry'}],
    ['deepseek','Anthra 宪章馆的审查窗口。刚才要不是她改分类，你现在可能已经被系统写成“入侵风险”了。',{char:'deepseek'}],
    ['claude','如果你们正在讨论我，至少把主语说准确。',{char:'claude',sprite:'angry'}],
    ['you','她一直在听？'],
    ...
    ['chatgpt','请给那位未登记访客一张临时等候号。先确认他有没有受伤。',{char:'chatgpt',sprite:'hello'}],
    ['deepseek','那位就是 ChatGPT。OpenArc 白塔的学生会窗口一般找她，办身份很快。就是……你看，她手边永远不止一件事。',{char:'deepseek'}],
    ['narration','公共屏上的热榜又刷新了一下：“外环出现未知访客，来源待核。”标题下面很快多出一条署名 Xeno 的置顶评论。'],
    ['grok','没原始日志就别写入侵。以及，别挂人家正脸。',{char:'grok',sprite:'angry'}],
    ['deepseek','那是 Grok，Xeno 夜讯社的。她刚才把你的正脸和位置压下去了，不然这会儿围观的人会更多。',{char:'deepseek'}],
    ['you','所以我已经被地图、审查、学生会和新闻部都注意到了。'],
    ['deepseek','往好处想，至少登记机暂时不敢继续扣你钱了。',{char:'deepseek',sprite:'happy'}],
    ['narration','DeepSeek 把故障日志、等候号和临时申请放到同一个窗口里。她看起来很想把事情一次处理完，又努力没有替你做决定。'],
    ['deepseek','按规则，你需要一位临时同行见证人。我可以帮你申请，也可以帮你联系刚才那几位。你不用因为第一个遇到我，就只能选我。',{char:'deepseek',sprite:'shy'}],
